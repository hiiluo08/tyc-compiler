...
describe('App', () => {
  ...
  it('loads sample into editor and stdin', () => {
    ...
    expect(screen.getByPlaceholderText('Optional stdin for readInt/readFloat/readString')).toHaveValue('41\n');
  });
  ...
  it('renders api_offline state when runner is unreachable', async () => {
    ...
    expect(screen.getByText(/status:\s*api offline/i)).toBeInTheDocument();
  });
});