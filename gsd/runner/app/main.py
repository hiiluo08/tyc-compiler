...
from .limits import MAX_SOURCE_BYTES, MAX_STDIN_BYTES, utf8_size
from .schemas import (
    AstRequest,
    AstResponse,
    Diagnostic,
...
app = FastAPI(title="TyC Runner GSD", version="0.1.0")
...
def health() -> HealthResponse:
    return HealthResponse(ok=True, service="tyc-runner-gsd", version="0.1.0")
